...
function* markerPoints(points, units, zoom) {
  ...
  let distanceNext = distanceInterval, label = interval;
...
function drawMarkers() {
  const mapLabel = (label) => `<div class="map-label"><div class="map-label-content">${label}</div><div class="map-label-arrow" /></div></div>`;
